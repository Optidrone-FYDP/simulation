...
MODEL_PATH = "drone_movement_model_lstm_1k_0.1_testtrain.pt"
SEQ_LENGTH = 10
...
current_position = np.array([start_TX, start_TY, start_TZ, start_RX, start_RY, start_RZ], dtype=np.float32)
...
output_df[["V_TX", "V_TY", "V_TZ", "V_RX", "V_RY", "V_RZ"]] = output_df[labels].diff().fillna(0)
output_df[["A_TX", "A_TY", "A_TZ", "A_RX", "A_RY", "A_RZ"]] = output_df[["V_TX", "V_TY", "V_TZ", "V_RX", "V_RY", "V_RZ"]].diff().fillna(0)
